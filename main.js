...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Alastor', 'Safari', '2.0.0'] : methodCodeQR ? ['Alastor-the-radio-bot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./Radiosession")
